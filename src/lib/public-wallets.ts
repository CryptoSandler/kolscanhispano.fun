...
// Reexportadas para quien ya las importaba de acá; viven en `truncate.ts`
// porque este módulo importa la base y un componente cliente no puede pagar eso.
export { truncateAddress, truncateAddressLong } from "./truncate";
import { truncateAddress, truncateAddressLong } from "./truncate";
